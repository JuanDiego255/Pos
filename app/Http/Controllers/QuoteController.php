...
class QuoteController extends Controller
{
    ...
    public function load_cart(Request $request)
    {
        ...
        $html_totales   .= '<div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="fw-medium">'. $data["moneda_pais"] .'' . number_format(($cart['exonerada'] + $cart['gravada'] + $cart['inafecta']), 2, ".", "") . '</span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="w-px-100">IGV:</span>
                                    <span class="fw-medium">'. $data["moneda_pais"] .'' . number_format($cart['igv'], 2, ".", "") . '</span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between">
                                    <span class="w-px-100">Total:</span>
                                    <span class="fw-medium">'. $data["moneda_pais"] .'' . number_format($cart['total'], 2, ".", "") . '</span>
                            </div>';
