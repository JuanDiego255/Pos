                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-info">
                                    <h5 class="mb-0">{{ $moneda_pais }}{{ number_format($sum_billings + $sum_sale_notes, 2, '.', '') }}
                                    </h5>
                ...
                <div class="col-xl-6 mb-4 col-md-3 col-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5 class="card-title mb-0">{{ $moneda_pais }}{{ number_format($bills, 2, '.', '') }}</h5>
                            <small class="text-muted">Gastos</small>
                        </div>
                        <div class="card-body">
                            <div id="expensesChart"></div>
                            <div class="mt-md-2 text-center mt-lg-3 mt-3">
                                <small class="text-muted mt-3">{{ $moneda_pais }}{{ number_format($bills_former, 2, '.', '') }} Gastos
                ...
                <div class="card-body">
                    <div class="row row-bordered g-0">
                        ...
                        <div class="col-md-4">
                            ...
                            <h3 class="text-center pt-4 mb-0">{{ $moneda_pais }}{{ number_format($ganancias, 2, '.', '') }}</h3>
                            <div class="px-3">
