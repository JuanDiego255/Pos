    ...
    $('body').on('click', '.btn-summary', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                close_block('#layout-content');
                $('#modalSummary .starting_amount').html(`${r.moneda_pais}${r.monto_inicial}`);
                if(r.bills_empty)
                {
                ...
                $('#modalSummary .sales_amount').html(`${r.moneda_pais}${r.monto_ventas}`);
                $('#modalSummary .quantity').html(r.cantidad_ventas);
                $('#modalSummary .total').html(`${r.moneda_pais}${r.total}`);
