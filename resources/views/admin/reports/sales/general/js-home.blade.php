        ...
        $.ajax({
            ...
            success     : function(r){
                                ...
                                $.each(r.doc_relacionados, function(i, doc_relacionado){
                                    if(doc_relacionado != null) {
                                        if(doc_relacionado.id == billing.idfactura_anular) {
                                            html_tbody += `<p class="pay_mode">${doc_relacionado.serie}-${doc_relacionado.correlativo}</p>`;
                                        }
                                    } else {
                ...
                html_tbody += `<tr>
                            ...
                            <tr>
                                <th colspan="10" class="text-end text-danger">Anulado ₡</th>
                                <td class="text-center text-danger">${parseFloat(total_anulado).toFixed(2)}</td>
                            </tr>
                            <tr>
                                <th colspan="10" class="text-end">Total Neto ₡</th>
