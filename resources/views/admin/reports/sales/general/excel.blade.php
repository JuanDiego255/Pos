    ...
    <div id="items">
        <table id="table_items">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td colspan="10" class="text-right border-solid" style="text-align: right; border: 1px solid #151515">Total ₡&nbsp;</td>
                    <td class="td_items border-solid" style="text-align: center; border: 1px solid #151515" data-format="0.00">{{ number_format($total, 2, '.', '') }}</td>
                </tr>
                <tr>
                    <td colspan="10" class="text-right border-solid text-danger" style="text-align: right; border: 1px solid #151515">Anulado ₡&nbsp;</td>
                ...
                <tr>
                    <td colspan="10" class="text-right border-solid" style="text-align: right; border: 1px solid #151515">Total Neto ₡&nbsp;</td>
