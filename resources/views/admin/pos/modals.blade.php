                ...
                <form id="form-save-sale" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-md-12 mb-3 mb-xl-0">
                            ...
                            <p>Documento</p>
                            <div class="row mt-2">
                                <input type="hidden" name="iddocumento_tipo" value="7">
                                <div class="col-md">
                                ...
                                {{-- <div class="col-md mb-md-0 mb-2">
                                    <div class="form-check custom-option custom-option-icon position-relative checked">
                                        <label class="form-check-label custom-option-content btn-type-document"
                                            ...
                                            <input id="boleta" class="form-check-input" type="radio" value="2"
                                ...
                                <div class="col-md mb-md-0 mb-2">
                                    <div class="form-check custom-option custom-option-icon position-relative">
                                        <label class="form-check-label custom-option-content btn-type-document"
                                            ...
                                            <input id="factura" class="form-check-input" type="radio" value="1"
                                                name="type_document">
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-sm-7 col-md-12 col-lg-7">
                            <div class="form-group"><label class="form-label">Forma de Pago</label>
                                <div class="row mb-3 shadow-payment">
                                                ...
                                                <div class="el-input el-input--small is-disabled el-input--suffix">
                                                    <select class="form-control" id="modo_pago" name="modo_pago">
                                                        @foreach ($modo_pagos as $modo_pago)
                                                            <option value="{{ $modo_pago->id }}">
                                                                {{ $modo_pago->descripcion }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-1">
                                            <div class="text-end el-input-number el-input-number--small"
                                                required="required">
                                        ...
                                        <div class="form-group mb-1">
                                            <div class="text-end el-input-number el-input-number--small"
                                                ...
                                                <div class="el-input el-input--small">
                                                    <input type="text" autocomplete="off" max="Infinity"
                                                        min="0" class="form-control" role="spinbutton"
                                                        name="quantity_paying_2" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group mb-1">
                                            <div class="text-end el-input-number el-input-number--small"
                                                ...
                                                <div class="el-input el-input--small">
                                                    <input type="text" autocomplete="off" max="Infinity"
                                                        min="0" class="form-control" role="spinbutton"
                                                        name="quantity_paying_3" value="0">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-sm-5 col-md-12 col-lg-5">
                            <div class="form-group text-end h-100"><label class="control-label fw-bold">&nbsp;</label>
                                    ...
                                    <div id="card-body-totals" class="card-body d-flex align-items-end">
                                        <div class="w-100" style="margin-bottom: 10px">
                                            <div class="row">
                                                ...
                                                <div class="col-6 pl-sm-0"><span class="fw-bold">{{ $moneda_pais }}
                                                        <span id="total_pay"></span></span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-6 pr-sm-0"><span
                                                ...
                                                <div class="col-6 pl-sm-0"><span class="fw-bold">{{ $moneda_pais }}
                                                        <span id="total_paying"></span></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6 pr-sm-0">
                                                    <span
                                                        class="fw-bold text-success wrapper_difference">Diferencia:</span>
                                                </div>
                                                <div class="col-6 pl-sm-0">
                                                    <span
                                                        class="fw-bold text-success wrapper_difference">{{ $moneda_pais }}
                                                        <span id="difference"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 mt-3 text-end">
                            ...
                            <button class="btn btn-primary btn-confirm-pay">
                                ...
                                <span class="spinner-border spinner-border-sm me-1 d-none text-confirm-payment"
