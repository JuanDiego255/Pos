                              ...
                              <div id="card-body-totals" class="card-body d-flex align-items-end">
                                  <div class="w-100" style="margin-bottom: 10px">
                                      <div class="row">
                                          ...
                                          <div class="col-6 pl-sm-0"><span class="fw-bold">{{ $moneda_pais }} <span id="total_pay"></span></span>
                                          </div>
                                      </div>
                                      <div class="row">
                                          <div class="col-6 pr-sm-0"><span
                                                  class="text-info fw-bold">Pagando:</span></div>
                                          <div class="col-6 pl-sm-0"><span class="fw-bold">{{ $moneda_pais }} <span id="total_paying"></span></span>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-6 pl-sm-0">
                                              <span class="fw-bold text-success wrapper_difference">{{ $moneda_pais }} <span id="difference"></span></span>
                                          </div>
                                      </div>
                                  </div>
                              </div>
