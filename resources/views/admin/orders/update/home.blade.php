...
@section('content')
    <div class="row invoice-preview" style="max-width: 1600px;">
        ...
        <!-- Invoice Actions -->
        <div class="col-12 col-md-6 invoice-actions">
            <div class="card invoice-preview-card">
                                    ...
                                    <div id="wrapper-totals" class="col-md-6 d-flex justify-content-end mt-3">
                                        <div class="invoice-calculations">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="fw-medium">{{ $moneda_pais }} <span class="span__subtotal">{{ number_format(($order->exonerada + $order->gravada + $order->inafecta), 2) }}</span> </span>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <span class="w-px-100">IGV:</span>
                                                <span class="fw-medium">{{ $moneda_pais }}<span class="span__igv">{{ $order->igv }}</span>
                                            </div>
                                            <hr>
                                            <div class="d-flex justify-content-between">
                                                <span class="w-px-100">Total:</span>
                                                <span class="fw-medium">{{ $moneda_pais }}<span class="span__total">{{ number_format($order->total, 2, ".", " ") }}</span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
