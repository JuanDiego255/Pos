...
class CreateDetailKitchenOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_kitchen_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('estado_producto')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('detail_kitchen_orders');
    }
}
