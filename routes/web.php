...
Route::post('/load-country'             , [BusinessController::class, 'load_country'])->name('admin.load_country');
...
Route::get('/kitchen-orders'                , [OrderController::class, 'kitchen_panel'])->name('admin.kitchen_panel')->middleware('auth');
Route::post('load-kitchen-orders'           , [OrderController::class, 'load_kitchen_orders'])->name('admin.load_kitchen_orders');
Route::post('change-status'                 , [OrderController::class, 'change_status'])->name('admin.change_status_product_kitchen');
